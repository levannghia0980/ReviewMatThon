...
class DeviceConfig:
    ...
    @classmethod
    def create_random(cls) -> "DeviceConfig":
        """Generate dynamic random device ID, iid, and tdid for concurrent requests bypass."""
        import random
        base = deepcopy(DEFAULT_DEVICE)
        rand_id = str(random.randint(7640000000000000000, 7649999999999999999))
        base["device_id"] = rand_id
        base["iid"] = rand_id
        base["tdid"] = rand_id
